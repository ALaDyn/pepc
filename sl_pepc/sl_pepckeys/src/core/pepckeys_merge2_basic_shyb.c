...
#define the_search_lt  pepckeys_sl_search_hybrid_lt
#define the_search_le  pepckeys_sl_search_hybrid_le
#define the_search_gt  pepckeys_sl_search_hybrid_gt
#define the_search_ge  pepckeys_sl_search_hybrid_ge

#define the_nmove      elem_nmove
#define the_rotate     pepckeys_elem_rotate


slint pepckeys_merge2_basic_shyb_x0_1(elements_t *s0, elements_t *s1, elements_t *sx) /* pepckeys_sl_proto, sl_func pepckeys_merge2_basic_shyb_x0_1 */
{
  slint n, l;
...
slint pepckeys_merge2_basic_shyb_0x_1(elements_t *s0, elements_t *s1, elements_t *sx) /* pepckeys_sl_proto, sl_func pepckeys_merge2_basic_shyb_0x_1 */
{
  slint n, l;
...
slint pepckeys_merge2_basic_shyb_01_x(elements_t *s0, elements_t *s1, elements_t *sx) /* pepckeys_sl_proto, sl_func pepckeys_merge2_basic_shyb_01_x */
{
  return pepckeys_merge2_basic_01_x(s0, s1, sx, pepckeys_merge2_basic_shyb_x0_1, pepckeys_merge2_basic_shyb_0x_1);
}


slint pepckeys_merge2_basic_shyb_01(elements_t *s0, elements_t *s1, elements_t *t) /* pepckeys_sl_proto, sl_func pepckeys_merge2_basic_shyb_01 */
{
  slint k, l;
