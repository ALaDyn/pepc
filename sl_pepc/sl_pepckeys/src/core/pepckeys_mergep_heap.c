 ...
 *  
 *  file: src/core/pepckeys_mergep_heap.c
 *  timestamp: 2010-01-08 17:32:19 +0100
 *  
 */
...
slint pepckeys_mergep_heap(elements_t *s, elements_t *d, slint_t p, slindex_t *displs, slindex_t *counts) /* pepckeys_sl_proto, sl_func pepckeys_mergep_heap */
{
...
slint pepckeys_mergep_heap_unpack(packed_elements_t *s, elements_t *d, slint_t p, slindex_t *displs, slindex_t *counts) /* pepckeys_sl_proto, sl_func pepckeys_mergep_heap_unpack */
{
  slkey_pure_t heap_keys[p], hkx;
  slint_t heap_sources[p], hsx;
  slint_t heap_size = 0;
...
slint pepckeys_mergep_heap_unpack_indices(packed_elements_t *s, elements_t *d, slint_t p, slindex_t *displs, slindex_t *counts) /* pepckeys_sl_proto, sl_func pepckeys_mergep_heap_unpack_indices */
{
  slkey_pure_t heap_keys[p], hkx;
  slint_t heap_sources[p], hsx;
  slint_t heap_size = 0;
