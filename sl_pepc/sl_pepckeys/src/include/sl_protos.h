...
slint pepckeys_mergep_heap(elements_t *s, elements_t *d, slint_t p, slindex_t *displs, slindex_t *counts);
slint pepckeys_mergep_heap_unpack(packed_elements_t *s, elements_t *d, slint_t p, slindex_t *displs, slindex_t *counts);
slint pepckeys_mergep_heap_unpack_indices(packed_elements_t *s, elements_t *d, slint_t p, slindex_t *displs, slindex_t *counts);
