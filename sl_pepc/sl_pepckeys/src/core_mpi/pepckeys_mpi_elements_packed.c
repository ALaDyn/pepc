...
slint_t pepckeys_mpi_elements_packed_datatype_create(MPI_Datatype *pdt, slint_t structured) /* pepckeys_sl_proto, sl_func pepckeys_mpi_elements_packed_datatype_create */
{
  packed_element_t pe;
...
slint_t pepckeys_mpi_elements_packed_datatype_destroy(MPI_Datatype *pdt) /* pepckeys_sl_proto, sl_func pepckeys_mpi_elements_packed_datatype_destroy */
{
  MPI_Type_free(pdt);
