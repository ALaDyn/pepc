...
slint pepcparts_split2_lt_ge(elements_t *s, slkey_pure_t *k, elements_t *t) /* pepcparts_sl_proto, sl_func pepcparts_split2_lt_ge */
{
  elements_t low, high;
...
slint pepcparts_split2_le_gt(elements_t *s, slkey_pure_t *k, elements_t *t) /* pepcparts_sl_proto, sl_func pepcparts_split2_le_gt */
{
  elements_t low, high;
...
slint pepcparts_split3_lt_eq_gt(elements_t *s, slkey_pure_t *k, elements_t *t, slint *nlt, slint *nle) /* pepcparts_sl_proto, sl_func pepcparts_split3_lt_eq_gt */
{
...
slint pepcparts_split3_lt_eq_gt_old(elements_t *s, slkey_pure_t *k, elements_t *t, slint *nlt, slint *nle) /* pepcparts_sl_proto, sl_func pepcparts_split3_lt_eq_gt_old */
{
  elements_t low, high, middle;
...
slint pepcparts_split2_b(elements_t *s, elements_t *sx, slkey_pure_t bmask) /* pepcparts_sl_proto, sl_func pepcparts_split2_b */
{
  elements_t xl, xh;
...
slint pepcparts_splitk_k2c_af(elements_t *s, elements_t *sx, slint k, slint *c, k2c_func k2c, void *k2c_data) /* pepcparts_sl_proto, sl_func pepcparts_splitk_k2c_af */
{
  slint i, j;
  elements_t xi, end;
...
slint pepcparts_splitk_k2c(elements_t *s, elements_t *sx, slint k, slint *c, k2c_func k2c, void *k2c_data) /* pepcparts_sl_proto, sl_func pepcparts_splitk_k2c */
{
  slint i, j, l;
  elements_t xi, end;
...
slint pepcparts_splitk_k2c_count(elements_t *s, slint k, slint *c, k2c_func k2c, void *k2c_data) /* pepcparts_sl_proto, sl_func pepcparts_splitk_k2c_count */
{
  slint i, j;
