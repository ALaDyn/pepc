 ...
 *  
 *  file: src/core_mpi/pepckeys_mpi_find_exact.c
...
slint_t pepckeys_mpi_find_exact_equal(elements_t *s, slint_t other_rank, slint_t high_rank, slint_t *ex_start, slint_t *ex_size, int size, int rank, MPI_Comm comm) /* pepckeys_sl_proto, sl_func pepckeys_mpi_find_exact_equal */
{
  const int tag = 1;
  ...
  *my_cmp_i = s->size;
  ...
  {
    fprintf(stderr, "pepckeys_mpi_find_exact_equal: error: element lists not equal (%" sl_int_type_fmt " vs. %" sl_int_type_fmt ")\n", *my_cmp_i, *other_cmp_i);
    return -1;
  }
#endif
...
slint_t pepckeys_mpi_find_exact(elements_t *s, slint_t other_rank, slint_t high_rank, slint_t *dst_size, slint_t *ex_start, slint_t *ex_sizes, slint_t *nx_move, int size, int rank, MPI_Comm comm) /* pepckeys_sl_proto, sl_func pepckeys_mpi_find_exact */
{
  const int tag = 1;
  ...
  pepckeys_mpi_find_exact_equal(&interval, other_rank, high_rank, ex_start, ex_sizes, size, rank, comm);
