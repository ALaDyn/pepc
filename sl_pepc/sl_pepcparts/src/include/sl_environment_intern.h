...
# define sl_srand(s)         srand(s)
 ...
 #undef sl_ts_get_s
  ...
  #define sl_ts_get_ms()             (sl_ts_save(pepcparts_ts_temp), (double) (pepcparts_ts_temp.tv_sec * 1000.0 + pepcparts_ts_temp.tv_usec / 1000.0))
  #define sl_ts_diff_s(from, to)     ((double) (((to).tv_sec - (from).tv_sec) + ((to).tv_usec - (from).tv_usec) / 1000000.0))
  #define sl_ts_get_s()              (sl_ts_save(pepcparts_ts_temp), (double) (pepcparts_ts_temp.tv_sec + pepcparts_ts_temp.tv_usec / 1000000.0))

  #define declare_ts_temp            sl_ts_type pepcparts_ts_temp;
  extern sl_ts_type pepcparts_ts_temp;  /* sl_var pepcparts_ts_temp */
