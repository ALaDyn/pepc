...
#define the_search_lt  pepcparts_sl_search_sequential_lt
#define the_search_le  pepcparts_sl_search_sequential_le
#define the_search_gt  pepcparts_sl_search_sequential_gt
#define the_search_ge  pepcparts_sl_search_sequential_ge

#define the_nmove      elem_nmove
#define the_rotate     pepcparts_elem_rotate


slint pepcparts_merge2_basic_sseq_x0_1(elements_t *s0, elements_t *s1, elements_t *sx) /* pepcparts_sl_proto, sl_func pepcparts_merge2_basic_sseq_x0_1 */
{
  slint n;
...
slint pepcparts_merge2_basic_sseq_0x_1(elements_t *s0, elements_t *s1, elements_t *sx) /* pepcparts_sl_proto, sl_func pepcparts_merge2_basic_sseq_0x_1 */
{
  slint n;
...
slint pepcparts_merge2_basic_sseq_01_x(elements_t *s0, elements_t *s1, elements_t *sx) /* pepcparts_sl_proto, sl_func pepcparts_merge2_basic_sseq_01_x */
{
  return pepcparts_merge2_basic_01_x(s0, s1, sx, pepcparts_merge2_basic_sseq_x0_1, pepcparts_merge2_basic_sseq_0x_1);
}


slint pepcparts_merge2_basic_sseq_01(elements_t *s0, elements_t *s1, elements_t *t) /* pepcparts_sl_proto, sl_func pepcparts_merge2_basic_sseq_01 */
{
  slint k;
