...
slint pepcparts_merge2_basic_straight_x0_1(elements_t *s0, elements_t *s1, elements_t *sx) /* pepcparts_sl_proto, sl_func pepcparts_merge2_basic_straight_x0_1 */
{
...
slint pepcparts_merge2_basic_straight_0x_1(elements_t *s0, elements_t *s1, elements_t *sx) /* pepcparts_sl_proto, sl_func pepcparts_merge2_basic_straight_0x_1 */
{
  elements_t src0, src0e, src1, src1e, dst;
...
slint pepcparts_merge2_basic_straight_01_x(elements_t *s0, elements_t *s1, elements_t *sx) /* pepcparts_sl_proto, sl_func pepcparts_merge2_basic_straight_01_x */
{
  return pepcparts_merge2_basic_01_x(s0, s1, sx, pepcparts_merge2_basic_straight_x0_1, pepcparts_merge2_basic_straight_0x_1);
}


slint pepcparts_merge2_basic_straight_x_0_1(elements_t *s0, elements_t *s1, elements_t *sx) /* pepcparts_sl_proto, sl_func pepcparts_merge2_basic_straight_x_0_1 */
{
...
slint pepcparts_merge2_basic_straight_X0_1(elements_t *s0, elements_t *s1, elements_t *sx, elements_t *t) /* pepcparts_sl_proto, sl_func pepcparts_merge2_basic_straight_X0_1 */
{
  ...
  pepcparts_elem_nxchange_ro0(&src1, &dst, src1.size, t);

  return 0;
}


slint pepcparts_merge2_basic_straight_0X_1(elements_t *s0, elements_t *s1, elements_t *sx, elements_t *t) /* pepcparts_sl_proto, sl_func pepcparts_merge2_basic_straight_0X_1 */
{
  ...
  elem_inc(&src0);
  pepcparts_elem_nxchange_ro0(s1, &src0, src1.size, t);

  return 0;
}


slint pepcparts_merge2_basic_straight_01_X(elements_t *s0, elements_t *s1, elements_t *sx, elements_t *t) /* pepcparts_sl_proto, sl_func pepcparts_merge2_basic_straight_01_X */
{
  return pepcparts_merge2_basic_01_X(s0, s1, sx, t, pepcparts_merge2_basic_straight_X0_1, pepcparts_merge2_basic_straight_0X_1);
}


slint pepcparts_merge2_basic_straight_X0_1u(elements_t *s0, elements_t *s1, elements_t *sx, elements_t *t) /* pepcparts_sl_proto, sl_func pepcparts_merge2_basic_straight_X0_1u */
{
  elements_t src0, src0e, src1, src1l, dst;
