...
slint pepcparts_sn_hypercube_lh(slint size, slint rank, slint stage, void *snp, slint *up) /* pepcparts_sl_proto, sl_func pepcparts_sn_hypercube_lh */
{
  slint stages = pepcparts_ilog2f(size);
...
slint pepcparts_sn_hypercube_hl(slint size, slint rank, slint stage, void *snp, slint *up) /* pepcparts_sl_proto, sl_func pepcparts_sn_hypercube_hl */
{
  slint stages = pepcparts_ilog2f(size);
...
slint pepcparts_sn_odd_even_trans(slint size, slint rank, slint stage, void *snp, slint *up) /* pepcparts_sl_proto, sl_func pepcparts_sn_odd_even_trans */
{
  slint stages = size;
...
slint pepcparts_sn_batcher(slint size, slint rank, slint stage, void *snp, slint *up) /* pepcparts_sl_proto, sl_func pepcparts_sn_batcher */
{
  slint stages, _p, p, q, r, d;

  _p = pepcparts_ilog2f(size);
  stages = (_p * (_p + 1)) / 2;
...
slint pepcparts_sn_bitonic(slint size, slint rank, slint stage, void *snp, slint *up) /* pepcparts_sl_proto, sl_func pepcparts_sn_bitonic */
{
  slint stages, p, i = 0;

  p = pepcparts_ilog2f(size);
  stages = (p * (p + 1)) / 2;
...
/* connected */
slint pepcparts_sn_connected(slint size, slint rank, slint stage, void *snp, slint *up) /* pepcparts_sl_proto, sl_func pepcparts_sn_connected */
{
