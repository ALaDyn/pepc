...
slint pepcparts_ilog2c(slint x) /* pepcparts_sl_proto, sl_func pepcparts_ilog2c */
{
  slint l = 0;
  while (x /= 2) ++l;
  return l;
...
slint pepcparts_ilog2f(slint x) /* pepcparts_sl_proto, sl_func pepcparts_ilog2f */
{
  slint l = 0;
  if (x <= 1) return 0;
  --x;
...
slint pepcparts_print_bits(slint v) /* pepcparts_sl_proto, sl_func pepcparts_sl_proto pepcparts_print_bits */
{
  slint i;
...
slint pepcparts_pivot_random(elements_t *s) /* pepcparts_sl_proto, sl_func pepcparts_pivot_random */
{
