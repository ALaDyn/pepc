 ...
 *  
 *  file: src/core/pepcparts_merge2_compo_tridgell.c
...
#define the_merge_x_0_1  pepcparts_merge2_basic_straight_x_0_1
...
slint pepcparts_merge2_compo_tridgell(elements_t *s0, elements_t *s1, elements_t *sx) /* pepcparts_sl_proto, sl_func pepcparts_merge2_compo_tridgell */
{
...
/*  printf("jetzt gehts los!\n");
  ...
  {
    sx = &_sx;
    pepcparts_elements_alloc(sx, 3 * blocksize, 1, 1);
  }
...
/*  for (i = 0; i < nblocks; ++i)
  {
    ...
    pepcparts_elements_print_keys(&blocks[i].s);
  }*/
