 ...
 *  
 *  file: src/core_mpi/pepcparts_mpi_sample_precise_counts.c
...
slint pepcparts_mpi_sample_precise_counts(elements_t *s, slint threshold, classification_info *ci, int size, int rank, MPI_Comm comm) /* pepcparts_sl_proto, sl_func pepcparts_mpi_sample_precise_counts */
{
  slint i, j, k, l;
  elements_t _s, _e;
