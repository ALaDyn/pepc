 ...
 *  
 *  file: src/core_mpi/pepcparts_mpi_sample_permutation.c
...
slint pepcparts_mpi_sample_permutation(elements_t *s, classification_info *ci, int size, int rank, MPI_Comm comm) /* pepcparts_sl_proto, sl_func pepcparts_mpi_sample_permutation */
{
  slint i;
