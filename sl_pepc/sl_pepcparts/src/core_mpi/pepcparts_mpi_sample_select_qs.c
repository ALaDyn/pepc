 ...
 *  
 *  file: src/core_mpi/pepcparts_mpi_sample_select_qs.c
...
slint pepcparts_mpi_sample_select_qs(elements_t *s, slint threshold, classification_info *ci, int size, int rank, MPI_Comm comm) /* pepcparts_sl_proto, sl_func pepcparts_mpi_sample_select_qs */
{
  slint i;
  ...
  pepcparts_mpi_select_qs(s, size - 1, iths, pepcparts_pivot_random, threshold, ci->keys, size, rank, comm);
