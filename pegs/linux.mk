...
#PREPROC = -UVISIT_NBODY

#VPREFIX=$(HOME)/visit/demo/xnbody_pepc
#APISDIR=$(VPREFIX)/apis

#VISITLIBS=-L$(VPREFIX)/apis/nbody3 -llvisit_nbody2 -L$(VPREFIX)/lvisit/lib -llvisit -L$(VPREFIX)/visit_dist/lib -lvisit
#NETCDFLIB = -lnetcdf
