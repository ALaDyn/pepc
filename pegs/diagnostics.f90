...
subroutine diagnostics
  ...
  if (itime>0 .and. mod(itime,idump)==0)  call dump(itime+itime_start)     ! Dump complete set of particle data
! if ( vis_on .and. mod(itime,ivis*2)==0 .and. steering) call vis_steer
