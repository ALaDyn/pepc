...
!   $Revision: 1.0 $
!
!     Allocate main tree and physics arrays
!
!  ================================


subroutine setup_arrays(nparticle)
  ...
  integer :: k, maxleaf, maxtwig

  npartm = 3*nparticle  ! allow 50% fluctuation

  nppm = max(npartm/num_pe,1000)
  nshortm = 1500    ! Max shortlist length: leave safety factor for nshort_list in FORCES
