...
!  call laser_setup()
      ...
      call WriteParameter(ifile, "position update (vte) : max dt", maxdt(3))
      call WriteParameter(ifile, "velocity update (vte) : max dt", maxdt(4))
      call WriteParameter(ifile, "position update (vosc): max dt", maxdt(5))
      call WriteParameter(ifile, "velocity update (vosc): max dt", maxdt(6))
