...
!======================================================================================
  subroutine set_parameter()
    ...
    namelist /pepcf/ tnpp, nt, dt, Bx, By, Bz, delx, dely, delz, ni, ne, te_ev, ti_ev, quelltyp, tnwpy, tnwpz, dx ,dy, dz
    ...
    if(root) then
      ...
      write(*,'(a,es12.4)') " == particles / debye spehere        : ", tnpp/(dx*dy*dz)*l_debye**3
      ...
      if (B.ne.0.) then
          ...
          write(*,'(a,es10.2,a,es10.2,a,es10.2)')  " == dy (gyro_radii, debye_legths, m) : ", dely,", ",dy/l_debye,", ",dy
          write(*,'(a,es10.2,a,es10.2,a,es10.2)')  " == dz (gyro_radii, debye_legths, m) : ", delz,", ",dz/l_debye,", ",dz
      else
