...
subroutine rezone
   ...
   if (my_rank .eq. 0) write (*, *) 'total # particles removed ', nremove_tot
   ...
   if (my_rank .eq. n_cpu - 1) then
      ...
      if (nremove_tot .lt. 2 * nslice) then
   ...
   if (my_rank .eq. 0) write (*, *) 'total # particles added ', 2 * nslice
   ...
   if (my_rank .eq. n_cpu - 1) then
      ...
      do i = 1, nslice
         ...
         yt = r_sphere
         zt = r_sphere
         do while (yt**2 + zt**2 .gt. r_sphere**2)
