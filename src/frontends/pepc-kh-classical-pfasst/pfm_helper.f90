module pfm_helper
  ...
  contains
    ...
    subroutine pfm_fill_pfasst_object(pf, encap, sweeper, pf_nml, level_params, root_file)
        ...
        pf%echo_timings = pf_nml%echo_timings .and. root_file
    ...
    subroutine read_in_pf_params(pf_namelist, rank, comm)
        ...
        namelist /pfasst/ niter, num_space_instances, nlevels, nnodes, echo_timings, echo_errors, nsweeps, res_tol, color_space_div, color_time_div, theta, directforce, fevaL_mode
