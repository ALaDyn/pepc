...
!VAMPINST subroutine_start
       CALL VTENTER(IF_dump,VTNOSCL,VTIERR)
!      write(*,*) 'VT: dump S>',VTIERR,
!     *    IF_dump,ICLASSH
!
  ...
  open (60,file=cfile) 
  write(60,'((8(1pe14.5),2i9))')  &
       (x(i), y(i), z(i), ux(i), uy(i), uz(i), q(i), m(i), pepid(i), pelabel(i),i=1,npp)
  close(60)
...
!      write(*,*) 'VT: dump S<',VTIERR,ICLASSH
!
end subroutine dump
