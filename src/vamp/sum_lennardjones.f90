...
!VAMPINST subroutine_start
       CALL VTENTER(IF_sum_lennardjones,VTNOSCL,VTIERR)
!      write(*,*) 'VT: sum_lennardjones S>',VTIERR,
!     *    IF_sum_lennardjones,ICLASSH
!
  a_bond=a_ii*sqrt(2.)
  epsc = 0.8 ! cutoff
  sumfx = 0
...
!      write(*,*) 'VT: sum_lennardjones S<',VTIERR,ICLASSH
!
