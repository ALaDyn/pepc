...
!
  ...
  real :: axdum, aydum, azdum
  integer :: ioffset, i1, i2, npp_partial, npp_total, ipass, me_read, j, nrest, nadd

 
!VAMPINST subroutine_start
       CALL VTENTER(IF_predef_parts,VTNOSCL,VTIERR)
!      write(*,*) 'VT: predef_parts S>',VTIERR,
!     *    IF_predef_parts,ICLASSH
!
  if (me == 0) then 
...
!      write(*,*) 'VT: predef_parts S<',VTIERR,ICLASSH
!
        stop
     endif
 ...
 ! Filename (directory) prefix
  ...
  !  Skip dummy blocks up to previous PEs 
    do j=0,mod(me,nmerge)-1
      ...
      read(60,*) (x(i),y(i),z(i),ux(i),uy(i),uz(i),q(i),m(i),idummy,pelabel(i),i=1,npp)
  ! read from vis data
  !    read(60,*) (x(i),y(i),z(i),ux(i),uy(i),uz(i),q(i),axdum,aydum,azdum &
  !    	,idummy,pelabel(i),i=1,npp)
    end do
    
   !  Now read in particles to keep
     read(60,*) (x(i),y(i),z(i),ux(i),uy(i),uz(i),q(i),m(i),idummy,pelabel(i),i=1,npp+nadd)
  ! read from vis data
  !    read(60,*) (x(i),y(i),z(i),ux(i),uy(i),uz(i),q(i),axdum,aydum,azdum &
  !    	,idummy,pelabel(i),i=1,npp)
    close (60)
...
! num_pe < # data sets, so merge together
  ...
  !  Initialise particles: read from file
    read(60,*) (x(i),y(i),z(i),ux(i),uy(i),uz(i),q(i),m(i),idummy,pelabel(i),i=i1,i2)
