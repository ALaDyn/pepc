...
!
  ...
  integer, parameter :: npart_visit_max = 25000  ! Max 25k data points for VIS
...
!VAMPINST subroutine_start
       CALL VTENTER(IF_visit_dump,VTNOSCL,VTIERR)
!      write(*,*) 'VT: visit_dump S>',VTIERR,
!     *    IF_visit_dump,ICLASSH
!
...
!      write(*,*) 'VT: visit_dump S<',VTIERR,ICLASSH
!
