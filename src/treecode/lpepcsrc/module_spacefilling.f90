...
!OMPSS!$omp parallel default(shared) private(j)
!OMPSS!$omp do
          do j = 1, nl
...
!OMPSS!$omp end parallel
        ...
        function intcoord_to_key_hilbert2D(ic)
          ...
          integer, parameter :: G2(0:3,0:1) = reshape([3,0,0,3,0,0,0,3],[4,2])
          integer(kind_key) :: horder ! order of the hilbert cell C
        ...
        function intcoord_to_key_hilbert3D(ic)
          ...
          integer, parameter :: G3(0:7,0:1) = reshape([5,6,0,5,5,0,6,5,0,0,0,5,0,0,6,5],[8,2])     ! 3D - hilbert gene
          integer(kind_key) :: horder ! order of the hilbert cell C
          integer :: exchange, reverse
        ...
        subroutine key_to_vecintcoord_hilbert(key, ic)
          ...
          integer, parameter :: G2(0:3,0:1) = reshape([3,0,0,3,0,0,0,3],[4,2]) ! 2D - hilbert gene
