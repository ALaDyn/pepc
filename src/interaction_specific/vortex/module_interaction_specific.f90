...
module module_interaction_specific
   ...
   interface
      ...
      end subroutine calc_force_per_interaction_with_leaf
      ...
      module subroutine calc_force_per_interaction_with_twig(particle, node, node_idx, delta, dist2, vbox)
         ...
         type(t_particle), intent(inout) :: particle
         real(kind_physics), intent(in) :: vbox(3), delta(3), dist2
      end subroutine calc_force_per_interaction_with_twig
   end interface
   ...
   ! Don`t like that I have to mark those public, but they would not be callable from the submodule otherwise...
   public cross_prod
   public G_core
   public calc_2nd_gaussian_transposed_direct
   public calc_6th_gaussian_transposed_direct
   public calc_6th_algebraic_transposed
   public calc_6th_algebraic_transposed_direct
