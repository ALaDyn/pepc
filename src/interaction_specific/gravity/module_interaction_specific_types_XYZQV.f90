...
module module_interaction_specific_types
      ...
      type t_particle_data
         real*8 :: q
         real*8 :: v(3)
         real*8 :: old_e(3) ! store t_particle_results%e of the previous time step
      ...
      integer, private, parameter :: nprops_multipole_moments = 2
...
!
        ...
        call vtkf%write_data_array("m", d(:)%q)
!
...
!
      ...
      subroutine register_interaction_specific_mpi_types(mpi_type_particle_data, MPI_TYPE_multipole_moments, mpi_type_particle_results)
        ...
        blocklengths(1:nprops_particle_data)  = [1, 3, 3]
        ...
        call MPI_GET_ADDRESS( dummy_particle_data%old_e, address(3), ierr )
        ...
        blocklengths(1:nprops_multipole_moments)  = [1, 1]
        types(1:nprops_multipole_moments)         = [MPI_REAL8, MPI_REAL8]
        ...
        call MPI_GET_ADDRESS( dummy_multipole_moments%bmax,       address(2), ierr )
