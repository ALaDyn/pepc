        ...
        subroutine calc_omega_tilde(particles)
          ...
          if (do_extrinsic_correction) then
            ...
            if (nfictcharge > 0) then
              do p=1,nfictcharge
                call addparticle(fictpos(1:2, p), fictcharge(p)%charge)
              end do
