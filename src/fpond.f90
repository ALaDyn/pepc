...
!  Use standard solution of Helmholtz equation for step profile
  ...
  gamma_s = sqrt(1.+4*a02/rho_upper)  ! gamma factor for EM solution at x=xc
...
!  Rpon = exp((-yd**2-zd**2)/sigma**2)  ! Gaussian
  ...
  Epon_x = 2*a02*Tpon*Rpon/gamma*xf*atten
  Epon_y = f2d*2*a02*Tpon*Xpon**2/gamma*yf*atten
  Epon_z = f2d*2*a02*Tpon*Xpon**2/gamma*zf*atten
