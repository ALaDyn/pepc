...
! Do label check
  ...
  rho_hot(0:ngx+1,0:ngy+1,0:ngz+1) = 0.
  jx_hot(0:ngx+1,0:ngy+1,0:ngz+1) = 0.
  jy_hot(0:ngx+1,0:ngy+1,0:ngz+1) = 0.
  jz_hot(0:ngx+1,0:ngy+1,0:ngz+1) = 0.
  ...
  sigma = 15.
  kmax = sigma*rdz    ! average over whole laser spot\
  nk = 2*kmax+1
  do j=1,ngy
     do i=1,ngx
