...
datanames=['$t [\mathrm{fs}]$',
           ...
           '$U_{\mathrm{before}}^{\mathrm{(e)}}$',
           '$U_{\mathrm{now}}^{\mathrm{(e)}}$',
           '$U_{\mathrm{0}}^{\mathrm{(e)}}$',
           '$\Delta U^{\mathrm{(e)}}$',
           '$\Sigma\,\Delta U^{\mathrm{(e)}}$',
           '$\mathcal{H}^{\mathrm{(e)}}$',
           '$U_{\mathrm{pot}}^{\mathrm{(i)}}$',
           '$U_{\mathrm{before}}^{\mathrm{(i)}}$',
           '$U_{\mathrm{now}}^{\mathrm{(i)}}$',
           '$U_{\mathrm{0}}^{\mathrm{(i)}}$',
           '$\Delta U^{\mathrm{(i)}}$',
           '$\Sigma\,\Delta U^{\mathrm{(i)}}$',
           '$\mathcal{H}^{\mathrm{(i)}}$',
           '$\Delta U^{\mathrm{(e)}} + \Delta U^{\mathrm{(i)}}$',
           '$\Sigma\,\Delta U^{\mathrm{(e)}} + \Sigma\,\Delta U^{\mathrm{(i)}}$',
...
for p in [5, 6, 7, 12, 13, 14, 15, 16, 17]:
...
Tempe = data[-1,4]/ (3./2.*kB*simparams["Ne"])
...
nuval = nu(Tempe, a*unit_t0_in_fs/simparams["Ne"], simparams)
