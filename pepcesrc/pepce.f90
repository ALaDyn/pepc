...
program pepce
  ...
  call setup_treearrays    ! Allocate array space for tree
  ...
  do itime = 1,nt
     ...
     call forces(1,npp,dt,t_domain,t_build,t_prefetch,t_walk,t_walkc,t_force)   ! Compute Coulomb forces using lpepc
