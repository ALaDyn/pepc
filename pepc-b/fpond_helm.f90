...
subroutine fpond_helm(t,tpulse,sigma_in,vosc,omega,x,y,z,ux,Az,nxh,xh_start,xh_end,dxh,x_crit,epon_x,epon_y,epon_z,phipon)
...
!		   epon_x,epon_y,epon_z,phipon)
  ...
  real, intent(in) :: x,y,z !< position to evaluate force; y,z relative to laser axis
  ...
  real :: xf, yf, zf, xh, Tpon, Rpon, Xpon, Ypon, Zpon, intensity, gamma, sigma, atten, theta
...
! include temporal phase factor  
  ...
  Epon1 = .25/dxh*( Azr_2**2-Azr_0**2 )
  Epon2 = .25/dxh*( Azr_3**2-Azr_1**2 )
